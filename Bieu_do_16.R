...
df_mac_covid <- read.csv('https://raw.githubusercontent.com/CSSEGISandData/COVID-19/master/csse_covid_19_data/csse_covid_19_time_series/time_series_covid19_confirmed_global.csv',
                        header = TRUE)
country = df_mac_covid$Country.Region
df_mac_covid = df_mac_covid[,5:ncol(df_mac_covid)]
data = data.frame(country,df_mac_covid)
